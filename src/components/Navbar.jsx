...
function NavMiddle({ href, text, largeDevice = "ml-0", xlDevice = "ml-0" }) {
  return (
    <li className="group relative">
      <a
        href={href}
        className={`ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:${largeDevice} lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:${xlDevice}`}
      >
        {text}
      </a>
    </li>
